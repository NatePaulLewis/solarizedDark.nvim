...
M.setup = function()
  ...
  local groups = {
    ...
    SolarizedBase2 = { fg = colors.base2 },
    ...
    StatusLine = { fg = colors.base03, bg = colors.base0, reverse = config.inverse },
    ...
    -- vim-startify
    StartifyBracket = { link = "SolarizedBase00" },
    StartifyFile = { link = "SolarizedBase0" },
    ...
    netrwLink = { link = "SolarizedBase1" },
    netrwSymLink = { link = "SolarizedBase0" },
    netrwExe = { link = "SolarizedYellow" },
    netrwComment = { link = "SolarizedBase1" },
    netrwList = { link = "SolarizedBlue" },
    netrwHelpCmd = { link = "SolarizedCyan" },
    netrwCmdSep = { link = "SolarizedBase00" },
    ...
    NERDTreeFile = { link = "SolarizedBase0" },
    NERDTreeExecFile = { link = "SolarizedYellow" },
    NERDTreeUp = { link = "SolarizedBase1" },
    NERDTreeCWD = { link = "SolarizedGreen" },
    NERDTreeHelp = { link = "SolarizedBase0" },
    ...
    CocCodeLens = { link = "SolarizedBase1" },
    ...
    -- nvim-cmp
    CmpItemAbbr = { link = "SolarizedBase2" },
    CmpItemAbbrDeprecated = { link = "SolarizedBase0" },
    CmpItemAbbrMatch = { link = "SolarizedBlue" },
    CmpItemAbbrMatchFuzzy = { link = "SolarizedBlueUnderline" },
    CmpItemMenu = { link = "SolarizedBase1" },
    ...
    htmlArg = { link = "SolarizedGreen" },
    htmlTagN = { link = "SolarizedBase0" },
    ...
    clojureParen = { link = "SolarizedBase00" },
    ...
    pythonDot = { link = "SolarizedBase00" },
    ...
    -- javascript
    javaScriptBraces = { link = "SolarizedBase0" },
    ...
    javaScriptParens = { link = "SolarizedBase00" },
    -- typescript
    ...
    typescriptGlobalObjects = { link = "SolarizedBase0" },
    typescriptParens = { link = "SolarizedBase00" },
    typescriptOpSymbols = { link = "SolarizedBase00" },
    typescriptHtmlElemProperties = { link = "SolarizedBase0" },
    ...
    purescriptModuleName = { link = "SolarizedBase0" },
    purescriptWhere = { link = "SolarizedCyan" },
    purescriptDelimiter = { link = "SolarizedBase01" },
    purescriptType = { link = "SolarizedBase0" },
    ...
    purescriptTypeVar = { link = "SolarizedBase0" },
    purescriptConstructor = { link = "SolarizedBase0" },
    purescriptFunction = { link = "SolarizedBase0" },
    purescriptConditional = { link = "SolarizedOrange" },
    purescriptBacktick = { link = "SolarizedOrange" },
    -- coffescript
    coffeeExtendedOp = { link = "SolarizedBase00" },
    coffeeSpecialOp = { link = "SolarizedBase00" },
    coffeeCurly = { link = "SolarizedOrange" },
    coffeeParen = { link = "SolarizedBase00" },
    ...
    -- moonscript
    moonSpecialOp = { link = "SolarizedBase00" },
    moonExtendedOp = { link = "SolarizedBase00" },
    moonFunction = { link = "SolarizedBase00" },
    ...
    javaParen = { link = "SolarizedBase00" },
    javaParen1 = { link = "SolarizedBase00" },
    javaParen2 = { link = "SolarizedBase00" },
    javaParen3 = { link = "SolarizedBase00" },
    javaParen4 = { link = "SolarizedBase00" },
    javaParen5 = { link = "SolarizedBase00" },
    ...
    -- scala
    scalaNameDefinition = { link = "SolarizedBase0" },
    scalaCaseFollowing = { link = "SolarizedBase0" },
    scalaCapitalWord = { link = "SolarizedBase0" },
    scalaTypeExtension = { link = "SolarizedBase0" },
    scalaKeyword = { link = "SolarizedRed" },
    scalaKeywordModifier = { link = "SolarizedRed" },
    scalaSpecial = { link = "SolarizedCyan" },
    scalaOperator = { link = "SolarizedBase0" },
    scalaTypeDeclaration = { link = "SolarizedYellow" },
    scalaTypeTypePostDeclaration = { link = "SolarizedYellow" },
    scalaInstanceDeclaration = { link = "SolarizedBase0" },
    ...
    markdownBlockquote = { link = "SolarizedBase1" },
    markdownListMarker = { link = "SolarizedBase1" },
    markdownOrderedListMarker = { link = "SolarizedBase1" },
    markdownRule = { link = "SolarizedBase1" },
    markdownHeadingRule = { link = "SolarizedBase1" },
    markdownUrlDelimiter = { link = "SolarizedBase00" },
    markdownLinkDelimiter = { link = "SolarizedBase00" },
    markdownLinkTextDelimiter = { link = "SolarizedBase00" },
    ...
    haskellSeparator = { link = "SolarizedBase01" },
    ...
    haskellPreProc = { link = "SolarizedBase01" },
    ...
    jsonBraces = { link = "SolarizedBase0" },
    jsonString = { link = "SolarizedBase0" },
    -- mail
    ...
    -- c#
    csBraces = { link = "SolarizedBase0" },
    csEndColon = { link = "SolarizedBase0" },
    csLogicSymbols = { link = "SolarizedBase0" },
    csParens = { link = "SolarizedBase00" },
    csOpSymbols = { link = "SolarizedBase00" },
    csInterpolationDelimiter = { link = "SolarizedBase00" },
    ...
    -- ocaml
    ocamlOperator = { link = "SolarizedBase0" },
    ...
    LspSagaCodeActionBorder = { link = "SolarizedBase0" },
    LspSagaCodeActionContent = { fg = colors.green, bold = config.bold },
    LspSagaLspFinderBorder = { link = "SolarizedBase0" },
    ...
    SagaShadow = { link = "SolarizedBase02" },
